...
def show_result_pyplot(model: BaseSegmentor,
    ...
    original_palette = model.dataset_meta['palette']
    custom_palette = list(original_palette)

    custom_palette[2] = [0, 0, 0]   # Building
    custom_palette[3] = [0, 0, 0]   # Wall
    custom_palette[4] = [0, 0, 0]
    custom_palette[8] = [0, 0, 0]
    custom_palette[9] = [0, 0, 0]
    custom_palette[10] = [0, 0, 0]
    custom_palette[16] = [0, 0, 0]
    custom_palette[18] = [0, 0, 0]
